...
final public class Digest {
     ...
     */    
    private Digest( String type) throws NoSuchAlgorithmException {
     ...
     * @param data os bytes que compõem a informação inicial a digerir
     * @throws NoSuchAlgorithmException 
     */ 
    ...
    /** Actualiza o "digest" com nova informação a digerir.
     * @param data os bytes que compõem a informação a digerir
     */    
